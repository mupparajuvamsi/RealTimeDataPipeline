...
object SparkScalaWriteToMongoDB {
  def main(args: Array[String]): Unit = {
    val spark = SparkSession.builder()
      ...
      .config("spark.mongodb.input.uri", "mongodb://3.88.225.247/sparkscalatest.empcollection")
      .config("spark.mongodb.output.uri", "mongodb://3.88.225.247/sparkscalatest.empcollection")
      .getOrCreate()
